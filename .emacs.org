...
#+begin_src emacs-lisp
  ...
  (setq
   user-mail-address (with-temp-buffer
                       (insert-file-contents "~/Documents/.emacs/email.txt")
...
*** Agenda
#+begin_src emacs-lisp
  (setq org-agenda-files (list "~/Documents/Org/Uni.org" "~/Documents/Org/Todo.org")
...
#+begin_src emacs-lisp
  ...
  (load "~/Documents/.emacs/newsticker.el")
#+end_src
** Dired
#+begin_src emacs-lisp
