...
#+begin_src emacs-lisp
  ...
  ;; (setq custom/package-list '(magit eglot company multiple-cursors))
  ;; (dolist (pkg custom/package-list)
...
#+begin_src emacs-lisp
  ...
  (when (member "IosevkaTerm Nerd Font Mono" (font-family-list))
    (set-frame-font "IosevkaTerm Nerd Font Mono 12" nil t))
